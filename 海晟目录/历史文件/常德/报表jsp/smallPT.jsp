...
<script>
    ...
    function setSQL(){
        ...
        sql += "   A.PTSX_AREA,";
        sql += getSqlDivisionExpression("A.PTSX_AREA","BC.CNTRCT_PLNT_AREA",true,2)+",";
        sql += "   STAND_T,";
        sql += "   STAND_F,";
        sql += "   EVAL_1,";
        sql += "   EVAL_2,";
        ...
        sql += "       SUM(PTSX_AREA)  AS PTSX_AREA,";
        sql += "       SUM(CASE WHEN IS_HIGH_STAND = '1'";
        sql += "         THEN PTSX_AREA";
        sql += "           ELSE 0 END) AS STAND_T,";
        sql += "       SUM(CASE WHEN IS_HIGH_STAND = '0'";
        sql += "         THEN PTSX_AREA";
        sql += "           ELSE 0 END) AS STAND_F,";
        sql += "       SUM(CASE";
        ...
        sql += "       SUM(B.PTSX_AREA)            AS PTSX_AREA,";
        sql += "       SUM(C.CNTRCT_PLNT_AREA)     AS CNTRCT_PLNT_AREA,";
        sql += "       COUNT(DISTINCT (";
        sql += "         CASE";
        sql += "         WHEN B.PTSX_AREA = C.CNTRCT_PLNT_AREA";
    ...
    function SetCellMouseLClick(col,row,updn){
        g_mouseLclickOrgCd = getCell(row,15);
    }
