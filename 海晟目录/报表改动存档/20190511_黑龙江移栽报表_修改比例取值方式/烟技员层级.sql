...
INNER JOIN
    (
        ...
        AND DATA_STATE='1'
        GROUP BY
            TECHNICIAN_ID) a ON a.org_cd=org.TECHNICIAN_ID
INNER JOIN
    (
        SELECT
            cd,
        ...
        FROM
            (
                ...
                FROM
                    ...
                    PT_DC_STAT_DATA_B B
                WHERE
                    B.DATA_STORE_BASE_TBL_ID = x.TRANSPLANT_FM_D_ID
                AND b.DATA_STATE='1'
                AND b.check_state='1'
                AND b.FEEDBACK_DATE>='2018-01-01 00:00:00'
                AND b.FEEDBACK_DATE<='2019-05-11 00:00:00'
                AND org.org_unique_cd = B.org_unique_cd
                AND org.SSTC ='41102301A')
        GROUP BY
            cd) b ON org.TECHNICIAN_ID = b.cd
LEFT JOIN
    (
        SELECT
            cd,
        ...
        FROM
            (
                ...
                FROM
                    ...
                    PT_DC_STAT_DATA_B B
                WHERE
                    B.DATA_STORE_BASE_TBL_ID = x.VELUM_FM_D_ID
                AND b.DATA_STATE='1'
                AND b.FEEDBACK_DATE>='2018-01-01 00:00:00'
                AND b.FEEDBACK_DATE<='2019-05-11 00:00:00'
                AND org.org_unique_cd = B.org_unique_cd
                AND org.SSTC ='41102301A')
        GROUP BY
            cd) c ON org.TECHNICIAN_ID = c.cd
LEFT JOIN
    (
        SELECT
            cd,
        ...
        GROUP BY
            cd) f ON org.TECHNICIAN_ID = f.cd
LEFT JOIN
    (
        SELECT
            cd,
        ...
        FROM
            (
                ...
                AND b.BUSINESS_DATE<='2019-05-11 00:00:00' )
        GROUP BY
            cd) e ON org.TECHNICIAN_ID = e.cd
LEFT JOIN --NEW 
(
  SELECT
    TECHNICIAN_ID                      AS cd,
...
) G ON G.CD = org.TECHNICIAN_ID
ORDER BY
    org.TECHNICIAN_NAME WITH ur