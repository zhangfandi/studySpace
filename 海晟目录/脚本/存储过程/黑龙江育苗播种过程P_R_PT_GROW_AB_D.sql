...
BEGIN
  ...
  DECLARE V_BILL_NO                 VARCHAR(64) DEFAULT 'TJ23000000000019';
  ...
  SELECT     A.ID,
    ...
    A.LAST_TIME,
	A.SERVER_ORG_NAME,
	A.GROW_POINT_TYPE_NAME,
	A.IS_COUNTRY_SUBSIDY,
	A.LONGITUDE,
	A.LATITUDE,
	A.LAND_AREA,
	B.DESTROY_AREA
    FROM V_PT_GROW_SEEDING_HLJ A
	LEFT JOIN V_PT_GROW_DESTROY_HLJ B ON A.BUSINESS_YEAR = B.BUSINESS_YEAR AND A.CANOPY_ID = B.CANOPY_ID
